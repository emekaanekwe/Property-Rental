property_details = "prop_id, streetnumber streetname streettype suburb statecode postcode, bedrooms, bathrooms, parking_spaces, latitude, longitude, floor_number, land_area, floor_area, price, property_features"
sample = "P10001(0),3 Antrim Place Langwarrin VIC 3910(1),4(2),2(3),2(4),-38.16655678(5),145.1838435(6),(7),608(8),257(9),870000(10),dishwasher;central heating(11)"

def extract_information(property_string: str) -> dict:
    property_dict = {}
    property_details = ["prop_id", "streetnumber", 
                    "streetname", "streettype", 
                    "suburb", "statecode", 
                    "postcode", "bedrooms", 
                    "bathrooms", "parking_spaces", 
                    "latitude", "longitude", 
                    "floor_number", "land_area", 
                    "floor_area", "price", "property_features"]
    split_property_string = property_string.split(",")
    for idx in range(len(property_details)):
        property_dict[idx] = split_property_string[idx]
